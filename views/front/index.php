               ...
               <div class="info-contact-agile">
                  ...
                  <?php
                    if (ISSET($_SESSION['type']) && ISSET($_SESSION['username'])) {
                        if ($_SESSION['type'] == 1) {
                            ?>
                            <li><i class="fas fa-envelope" aria-hidden="true"></i><a href="../back/index.html">Admin Dashboard</a></li>
                            <li><i class="fas fa-envelope" aria-hidden="true"></i><a href="../../core/logout.php">Se déconnecter</a></li>
                            <?php
                        } else {?>
                            <li><i class="fas fa-envelope" aria-hidden="true"></i><a href="../front/modifierUser.php?id=<?PHP echo   $_SESSION['id']; ?>">Profile</a></li>
                            <li><i class="fas fa-envelope" aria-hidden="true"></i><a href="../../core/logout.php">Se déconnecter</a></li>
                            <?php
                        }
                    }else{
