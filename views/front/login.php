...
<html lang="zxx">
   ...
   <body>
      ...
      <div class="email-sub-agile">
               <form method="post" action="../../core/loginC.php">
                  <div class="form-group sub-info-mail">
                     <input type="text" class="form-control email-sub-agile" placeholder="Username" name="username" id="username">
                  </div>
                  <div class="form-group sub-info-mail">
                     <input type="password" class="form-control email-sub-agile" placeholder="Password" name="password" id="password">
                  </div>
                  <br>  
